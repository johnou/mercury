 ...
 */
/*
 * Modified by Johnathan Crawford (johno.crawford@gmail.com)
 */
package it.johno.jira.mercury.osgi;
...
public class OSGiScriptEngineManager extends ScriptEngineManager {
    ...
    private final Logger logger = LogManager.getLogger(OSGiScriptEngineManager.class);
    ...
    private ClassLoader loadScriptEngineFactoryClassLoader(String factoryName) {
        ...
        try {
            ...
            logger.warn("Found ScriptEngineFactory candidate for "
    ...
    private ScriptEngineManagerInfo createScriptEngineManagerInfo(String factoryName, ClassLoader factoryLoader) {
        try {
            ...
            // May fail if script implementation is not in environment
            logger.warn("Found ScriptEngineFactory candidate for " + factoryName
    ...
    private void addJavaScriptEngine(List<String> factoryCandidates) {
        ...
        if (isClassDefined(RHINO_SCRIPT_ENGINE_FACTORY)) {
            ...
            logger.warn("No built-in JavaScript ScriptEngineFactory found.");
        }
    }
